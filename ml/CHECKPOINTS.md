...
asserts the served checkpoint is the real one). The deprecated sim **code** is regenerable from those
modules; the prior sim *weights* were not preserved. (Goal-035 correction: the file once named
