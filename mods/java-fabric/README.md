...
Drop `<world>/mineworld/live.json` and the mod switches from static playback to **live**:
...
- `MineworldMod.java` — Fabric entrypoint; auto-selects static (`frames.bin`) or live (`live.json`).
